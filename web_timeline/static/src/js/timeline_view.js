...
odoo.define("web_timeline.TimelineView", function (require) {
    ...
    const ControlPanel = require('web.ControlPanel');// e shtuar nga une
    const SearchPanel = require("web/static/src/js/views/search_panel.js");// e shtuar nga une
    ...
    var TimelineView = AbstractView.extend({
        ...
        withControlPanel: true,// e shtuar nga une
        withSearchPanel: true,// e shtuar nga une
        config: {
            Model: TimelineModel,
            Controller: TimelineController,
            Renderer: TimelineRenderer,
            ControlPanel,// e shtuar nga une
            SearchPanel,// e shtuar nga une
        },
